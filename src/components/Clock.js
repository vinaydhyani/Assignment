...
class Clock extends Component {
    ...
    gettimeZoneHours() {
        ...
        return new Date((typeof date === 'string' ? new Date (date) : date).toLocaleString('en-us', {timeZone: this.props.timeZone}));
    }

    render() {
        const hoursDegrees = this.gettimeZoneHours().getHours() * 30 + this.gettimeZoneHours().getMinutes() /2;
        const minutesDegrees = this.gettimeZoneHours().getMinutes() * 6 + this.gettimeZoneHours().getSeconds() /10;
        const secondsDegrees = this.gettimeZoneHours().getSeconds() * 6;
        const divStyleHours = {
        ...
        return (
            <div  key={this.props.index} className={`clock-container ${this.props.highlighted ? 'stylingmain': 'styling'} ${this.gettimeZoneHours().getHours() === 0 && this.gettimeZoneHours().getMinutes() === 0 && this.gettimeZoneHours().getSeconds() === 0 ? 'user-alert': 'usernon-alert'}`}>
          <div id="clock" className="clock-content" >
            ...
            <div
              ...
              className={
                ...
                (this.gettimeZoneHours().getHours() === 0 ? "" : "transition-effect")
              }
            ...
            <div
              ...
              className={
                ...
                (this.gettimeZoneHours().getMinutes() === 0 ? "" : "transition-effect")
              }
            ...
            <div
              ...
              className={
                "indicator seconds-indicator " +
                  (this.gettimeZoneHours().getSeconds() === 0 ? "" : "transition-effect")
              }
              style={divStyleSeconds}></div>
            <div className="indicator-cover">
            </div>
            <span className="indicator-name">{this.props.name}</span>
          </div>
        </div>
        );
    }
